...
public class Constants {
    ...
    public static final String LOGGER_METHODNAME = "methodName";

    public static final String LOGGER_REMOTEADDRESS = "remoteAddress";

    public static final String LOGGER_INTERFACE = "interface";
